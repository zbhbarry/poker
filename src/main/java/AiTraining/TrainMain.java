...
public class TrainMain {
    ...
    public static void main(String[] args) {
        ...
        DQNTrain dqnTrain=new DQNTrain();
        //dqnTrain.SelfTrain("dqn_model1.zip");
        ...
        int targetUpdateFreq = 1000;        // 目标网络同步间隔
        ...
        DQN dqn3= new DQN(inputSize, outputSize, gamma, learningRate, targetUpdateFreq, batchSize, epsilonMax, epsilonDecay, epsilonMin);
        //dqn1.loadModel("dqn_model1.zip");
        //dqn2.loadModel("dqn_model3.zip");



        Player player1=new DqnAgent("AI_1",CHIPS,dqn1,true);
        Player player2=new DqnAgent("AI_2",CHIPS,dqn2,false);
        Player player3=new DqnAgent("AI_3",CHIPS,dqn3,false);
      ...
      //  players.add(player6);
       ...
       // players.add(player5);
            ...
            //每50局训练一次，并且经验池的经验要大于batch的size
                ...
                for (Player player : players) {
                    ...
                    if(player instanceof DqnAgent dqnAgent) {
                        ...
                        d.setEpsilon(Math.max(d.getEpsilon(), epsilonMin)); // 确保 epsilon 不小于 epsilonMin
        ...
        String filePath = "dqn_model1.zip";
        dqn1.saveModel(filePath);

        String filePath1 ="dqn_model2.zip";
        dqn2.saveModel(filePath1);

        String filePath2 ="dqn_model3.zip";
        dqn3.saveModel(filePath2);
