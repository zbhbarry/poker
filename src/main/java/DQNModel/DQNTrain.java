...
public class DQNTrain {
    ...
    //自我训练方式
    public void SelfTrain(String filePath){
        ...
        DqnAgent player2=new DqnAgent("AI_2",CHIPS,dqn1,false);
        DqnAgent player3=new DqnAgent("AI_3",CHIPS,dqn2,false);
            ...
            for (Player player : players) {
                ...
                if(player instanceof DqnAgent dqnAgent ) {
                    ...
                    if (i % flush == 0) {
                        ...
                        player2.getDqn().getqNetwork().setParams(d.getqNetwork().params());
                        player3.getDqn().getqNetwork().setParams(d.getqNetwork().params());
                    }
                    // 在每局游戏开始时更新 epsilon
